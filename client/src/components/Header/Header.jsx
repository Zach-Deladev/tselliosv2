...
const Header = () => {
  ...
  // WhatsApp phone number format with country code, replace with your actual number
  const whatsAppNumber = "07902437653";
  const whatsAppLink = `https://wa.me/306977221245`;
            ...
            <div className="st-main-header-right">
              <div className="st-nav">
                ...
                >
                  ...
                  <div className="sp-phone-no">{whatsAppNumber}</div>
                </a>
              </div>
            </div>
          </div>
